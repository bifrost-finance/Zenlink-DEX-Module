...
fn foreign_create_pair_should_work() {
    new_test_ext().execute_with(|| {
        ...
        assert_ok!(DexPallet::create_pair(Origin::signed(ALICE), DEV_ASSET_ID, DOT_ASSET_ID));
        assert_ok!(DexPallet::create_pair(Origin::signed(ALICE), DEV_ASSET_ID, BTC_ASSET_ID));
        assert_ok!(DexPallet::create_pair(Origin::signed(ALICE), DEV_ASSET_ID, ETH_ASSET_ID));
        assert_ok!(DexPallet::create_pair(Origin::signed(ALICE), DOT_ASSET_ID, BTC_ASSET_ID));
        assert_ok!(DexPallet::create_pair(Origin::signed(ALICE), DOT_ASSET_ID, ETH_ASSET_ID));
...
fn inner_swap_assets_for_exact_assets_should_work() {
    new_test_ext().execute_with(|| {
        ...
        let amount_in_dot = total_supply_dot
            - supply_dot
        ...
        let amount_in_btc = total_supply_btc
            - supply_btc
